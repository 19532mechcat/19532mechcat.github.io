/*! hg-web-sdk@3.0.1 Copyright (C) 2017 - 2026 Hypergryph Co.,Ltd. All Rights Reserved. Published at 2026-09-07 18:17:11 */ !(function () {
  var t,
    e,
    n,
    r,
                  ...
                  return this.isObject(t)
                    ? ((function t(o, i) {
                        ...
                        if ("array" == s)
                          ...
                          for (var c in o)
                            t(o[c], i ? i + "%5B" + a(c) + "%5D" : a(c));
                        else (n || (e += "&"), (n = !1), (e += i + "=" + a(o)));
                      })(t, ""),
                      e)
                    : t;
                },
                              ...
                              (o.isObject(t) && (t = (n = t).url),
                                ...
                                v(l.p, function () {
                                  ...
                                  ((g[s] = g[s] || g[c] || ""),
                                    ...
                                    (n.url = t));
                                  var m = n;
                                  (p && (m = p.call(l, n, Promise) || n),
                                    f(m) || (m = Promise.resolve(m)),
                                    m.then(
                                      function (r) {
                                        r === n
                                          ? (function (n) {
                ...
                ["get", "post", "put", "patch", "head", "delete"].forEach(
                  function (t) {
                    a.prototype[t] = function (e, n, r) {
                      return this.request(e, n, o.merge({ method: t }, r));
                    };
                  },
                ),
      ...
      76: function (t) {
        ...
        function r(t, e) {
          ...
          return (
              ...
              (function () {
                for (var t = s.split("&"), e = 0, n = t.length; e < n; e++)
                  if (-1 != t[e].indexOf("=")) {
                    var o = t[e].indexOf("="),
                      i = t[e].slice(0, o);
                    ((o = t[e].slice(o + 1)), (r[i] = o));
                  }
              })(),
            (s = (function () {
              if (void 0 === s) return s;
              for (
                var e = s.split("&"), n = [], r = 0, o = e.length;
                r < o;
                r++
              )
                if (-1 != e[r].indexOf("=")) {
                ...
                for (
                  ...
                  if (-1 != t[e].indexOf("=")) {
                    var o = t[e].indexOf("="),
                      i = t[e].slice(0, o);
                    if (
                      ((o = t[e].slice(o + 1)), "adtag" === i.toLowerCase())
                    ) {
                      n = o;
                      break;
                    }
            ...
            { host: i, path: a, search: s, hash: c, param: r, adtag: n }
          );
        }
        function o(t) {
          var o = r(t),
            a = {
              ...
              si: "",
              url: o.path,
              arg: encodeURIComponent(o.search || "").substr(0, 512),
              ty: 0,
            };
          return (
            (a.pvi = (function () {
              if (t.userReport) {
                ...
                (r = e("pgv_pvi")) ||
                  ((a.ty = 1),
                  n("pgv_pvi", (r = i()), "Sun, 18 Jan 2038 00:00:00 GMT;"));
              return r;
            })()),
            (a.si = (function () {
              var t = e("pgv_si");
              return (t || n("pgv_si", (t = i("s"))), t);
            })()),
            (a.url = (function () {
              var e = o.path;
              return (
                t.senseQuery &&
                  (e += o.search
                    ? "?" + encodeURIComponent(o.search || "").substr(0, 512)
                    : ""),
                t.senseHash && (e += o.hash ? encodeURIComponent(o.hash) : ""),
                e
              );
            })()),
            a
            ...
            if (t.sid)
              if (
                ...
                for (
                  ...
                  for (var d in i[r])
                    i[r].hasOwnProperty(d) &&
                      e.push(d + "=" + (void 0 === i[r][d] ? "" : i[r][d]));
                var p = function (t) {
                  t =
          ...
          clickStat: function (t, e) {
            ...
            if (n.cid) {
              ...
              for (
                ...
                for (var p in n[d])
                  n[d].hasOwnProperty(p) &&
                    r.push(p + "=" + (void 0 === n[d][p] ? "" : n[d][p]));
              r =
                ("https:" == document.location.protocol
                  ? "https://pingtas.qq.com/webview"
                  : "http://pingtcss.qq.com") +
          ...
          clickShare: function (t) {
            ...
            if (e.cid) {
              ...
              for (
                ...
                for (var p in e[t])
                  e[t].hasOwnProperty(p) &&
                    n.push(p + "=" + (void 0 === e[t][p] ? "" : e[t][p]));
              p =
                ("https:" == document.location.protocol
                  ? "https://pingtas.qq.com/webview"
                  : "http://pingtcss.qq.com") +
  ...
  ((a.m = o),
    ...
    (a.u = function (t) {
      return (
        ...
        "." +
        {
          561: "28db840d58e3876b50b2",
          592: "19a532596d7fe4554fbf",
          815: "5029bfa794d7996fef17",
        }[t] +
        ".js"
      );
    }),
    ...
    (a.p = "https://web.hycdn.cn/hg_web_sdk/lib/3.0.1/"),
    (function () {
    ...
    (function () {
      ...
      var e = a(655),
        n = a(5478),
        r = {
          host: "https://binding-api-account-prod.hypergryph.com",
        ...
        i = {
          apiServer: new o("https://web-api.hypergryph.com"),
          bindingServer: new o(r.host),
        },
        s = a(4954),
        c = a.n(s),
        u = a(2914);
              ...
              qq: {
                ...
                update: function (t) {
                  var n = [
                    ...
                    r = (0, e.ev)(
                      [],
                      (0, e.CR)(document.head.querySelectorAll("meta")),
                      !1,
                    ).pop();
                  n.forEach(function (t) {
                    ...
                    (s ||
                      ...
                      s.setAttribute("itemProp", n || ""),
                      s.setAttribute("property", o || ""),
              ...
              wx: {
                ...
                init: function (t) {
                  ...
                  if (/MicroMessenger/i.test(navigator.userAgent)) {
                    ...
                    ((o.src = "//res2.wx.qq.com/open/js/jweixin-1.6.0.js"),
                      (o.onload = function () {
            ...
            return (
              ...
              e.mta &&
                n.analyticsInstances.push(
                  new f("boolean" == typeof e.mta ? void 0 : e.mta),
                ),
              e.gTag &&
                n.analyticsInstances.push(
                  new g("boolean" == typeof e.gTag ? void 0 : e.gTag),
                ),
              n
            );
          }
            ...
            (n.create = function (t) {
              return this._instance
                ? (console.warn(
                  ...
                  this._instance)
                : ((this._instance = new n(t)), this._instance);
            }),
      ...
      function _() {
        if (!window.HG_ACCOUNT_SDK)
          throw new Error("HG_ACCOUNT_SDK is not available");
        return window.HG_ACCOUNT_SDK;
      }
      function S() {
        return _().User;
      }
      function k(t, n) {
        return (0, e.mG)(this, void 0, void 0, function () {
          return (0, e.Jh)(this, function (e) {
            return [2, _().HG_SERVICE.general.sendSMS(t, n)];
          });
        });
      }
      var C = {
      ...
      var T = function (t) {
        var n = t.appcode,
          r = t.channel,
          o = t.sub_channel,
          i = t.availablePlatforms,
          a = void 0 === i ? ["Windows", "Android", "iOS", "PlayStation"] : i;
        return (0, e.mG)(void 0, void 0, void 0, function () {
          var t, i, s, c, u, l, d, p;
          return (0, e.Jh)(this, function (h) {
            switch (h.label) {
              case 0:
                ((t = new URL(
                  "https://launcher.hypergryph.com/api/game/info",
                )).searchParams.set("appcode", n),
                  t.searchParams.set("channel", r),
                  t.searchParams.set("sub_channel", o),
                  (i = (function (t) {
                    var n, r;
                    if (0 === t.length)
                      throw new Error("availablePlatforms is empty");
                    var o =
                    ...
                    try {
                      for (
                        var i = (0, e.XA)(t), a = i.next();
                        !a.done;
                        a = i.next()
                      ) {
                        var s = a.value;
                        if (I[s].test(o)) return s;
                      }
                    } catch (t) {
                      n = { error: t };
                    } finally {
                  ...
                  t.searchParams.set("platform", i),
                  (h.label = 1));
              case 1:
                return (h.trys.push([1, 4, , 5]), [4, fetch(t.toString())]);
              case 2:
                return (s = h.sent()).status >= 400 ? [2, null] : [4, s.json()];
              case 3:
                return (
                  (c = h.sent()),
                  (null === (u = c.app_info) || void 0 === u ? void 0 : u.name)
                    ? [
                        2,
                        {
                          name: c.app_info.name,
                          developer: c.app_info.developer_name || "-",
                          version:
                            (null === (l = c.package_info) || void 0 === l
                              ? void 0
                              : l.client_version) ||
                            (null === (d = c.package_info) || void 0 === d
                              ? void 0
                              : d.version) ||
                            "-",
                          updatedAt: (
                            null === (p = c.package_info) || void 0 === p
                              ? void 0
                              : p.publish_time
                          )
                            ? E()
                                .unix(Number(c.package_info.publish_time))
                                .format("YYYY/MM/DD")
                            : "-",
                        },
                      ]
                ...
                return [
                  2,
                  {
                    ...
                    data: {
                      product: "AK",
                      nameEN: "ARKNIGHTS",
                      nameCN: (null == t ? void 0 : t.name) || "明日方舟",
                      version: (null == t ? void 0 : t.version) || "-",
                      updatedAt: (null == t ? void 0 : t.updatedAt) || "-",
                      developer: (null == t ? void 0 : t.developer) || "-",
                    },
                  },
                ];
            }
      ...
      var A = a(3737),
        ...
        L = (function (t) {
          ...
          return (
            (0, e.ZT)(n, t),
            (n.prototype.setSlot = function () {
              return this;
            }),
            (n.prototype.setCopyrightImage = function () {
              return this;
            }),
            (n.prototype.updateHtml = function () {
              return this;
            }),
            n
          );
        ...
        P = function (t) {
          return (0, e.mG)(void 0, void 0, void 0, function () {
            ...
            return (0, e.Jh)(this, function (e) {
              switch (e.label) {
                case 0:
                  return [4, a.e(815).then(a.bind(a, 3815))];
                case 1:
                  return ((r = e.sent().renderFooter), [4, x()]);
                case 2:
                  return (
                    (o = e.sent()),
                    r(t, {
                      ...
                      siteInfos: [
                        "ICP",
                        "NCL",
                        { content: A.arknights.approval },
                        { content: A.arknights.ISBN },
                        "PSR",
                      ],
                      versionMeta: o.data,
                      ageTips: {
                        icon: n.L.arknights["age-tip"],
                        content: A.arknights.ageTips.join("；\n"),
                      },
                      externalLinks: [
                        "reportIllegalInfo",
      ...
      !(function (t) {
        ...
        ((0, e.ZT)(n, t),
          (n.create = function (t, e) {
            var r = new n(t, e.code, e.msg);
            return ((r.data = e.data), (r.detail = e.detail), r);
          }));
      })(j);
      var G = {
        ak: {
      ...
      var N = _().ETL,
        R = function (t) {
          var n,
            ...
            c = M(o),
            u = i
              ? { targetUrl: i.url, targetChannel: i.channel }
              : {
                  targetUrl:
                    null === (n = c.downloadConfig) || void 0 === n
                      ? void 0
                      : n.url,
                  targetChannel: "auto",
                },
          ...
          if (l) {
            try {
              var p = null == s ? void 0 : s.appId,
                h = (0, e.pi)(
                  (0, e.pi)({}, null == s ? void 0 : s.properties),
                  { download_channel: d },
                );
              p ? N.eventToAppId(p, "#download", h) : N.event("#download", h);
            } catch (t) {
            ...
            console.warn(
              ...
              "Params: ".concat(JSON.stringify({ game: o, target: i })),
            );
        },
        $ = { official: 1, bilibili: 2 };
      function U(t, n) {
        return (0, e.mG)(this, void 0, void 0, function () {
          return (0, e.Jh)(this, function (e) {
            return [2, _().U8_AK_SERVICE.getToken(t, n)];
          });
        });
      }
      var H = {
          CHANNEL_MAP: $,
          getTokenByHgCode: function (t, n) {
            return (
              void 0 === n && (n = 2),
              (0, e.mG)(this, void 0, void 0, function () {
                return (0, e.Jh)(this, function (e) {
                  return [2, U($.official, { type: n, code: t })];
                });
              })
            );
          },
          getTokenByBilibiliCode: function (t) {
            return (0, e.mG)(this, void 0, void 0, function () {
              return (0, e.Jh)(this, function (e) {
                return [2, U($.bilibili, { type: 1, code: t })];
              });
            });
          },
          getPlayerInfo: function (t, n) {
            var r;
            return (
              void 0 === n && (n = $.official),
              (0, e.mG)(this, void 0, void 0, function () {
                ...
                return (0, e.Jh)(this, function (d) {
                  switch (d.label) {
                      ...
                      return (
                        ...
                        c.result && u
                          ? [
                              4,
                              a.getInfo({
                                channelMasterId: $.official,
                                channelToken: { token: u },
                              }),
                            ]
                          : [3, 3]
                      );
                    case 2:
                      return (
                        (l = d.sent()).result ||
                          l.status !== s.U8.INVALID_TOKEN ||
                          i.clearToken(),
                        [2, l]
                      );
                    case 3:
                      return [2, (0, e.pi)((0, e.pi)({}, c), { data: void 0 })];
                  }
                });
              })
            );
          ...
          getPlayerInfoByToken: function (t) {
            return (0, e.mG)(this, void 0, void 0, function () {
              return (0, e.Jh)(this, function (e) {
                return [2, _().U8_AK_SERVICE.getInfo({ u8Token: t })];
              });
            });
          },
          insertFooter: P,
              ...
              return (0, e.Jh)(this, function (l) {
                switch (l.label) {
                  ...
                  case 2:
                    return (
                      (u = l.sent()).result ||
                        u.status !== a.U8.INVALID_TOKEN ||
                        o.clearToken(),
                      [2, u]
                    );
                  case 3:
                    return [2, (0, e.pi)((0, e.pi)({}, s), { data: void 0 })];
                }
              });
            });
          },
          getAccountChannel: function () {
            return (0, e.mG)(void 0, void 0, void 0, function () {
              ...
              return (0, e.Jh)(this, function (r) {
                switch (r.label) {
                  case 0:
                    return [4, _().accountInfo.get("ak")];
                  case 1:
                    return (t = r.sent()).result &&
                      ...
                      : [2, (0, e.pi)((0, e.pi)({}, t), { data: void 0 })];
                }
              });
            });
          },
          saveAccountChannel: function (t) {
            return _().accountInfo.set({ content: String(t) }, "ak");
          },
          clearAccountChannel: function () {
            return _().accountInfo.clear("ak");
          },
          getBilibiliToken: function () {
            return (0, e.mG)(void 0, void 0, void 0, function () {
              ...
              return (0, e.Jh)(this, function (r) {
                switch (r.label) {
                  case 0:
                    return [4, _().accountInfo.get("ak-b")];
                  case 1:
                    return (t = r.sent()).result &&
                      (null === (n = t.data) || void 0 === n
                        ? void 0
          ...
          saveBilibiliToken: function (t) {
            return _().accountInfo.set({ content: t }, "ak-b");
          },
          clearBilibiliToken: function () {
            return _().accountInfo.clear("ak-b");
          },
          download: function (t) {
            (void 0 === t && (t = {}),
              R((0, e.pi)((0, e.pi)({}, t), { game: "ak" })));
          },
        },
        q = function (t, n) {
          return (0, e.mG)(void 0, void 0, void 0, function () {
            ...
            return (0, e.Jh)(this, function (e) {
              switch (e.label) {
                ...
                case 1:
                  return (
                    (r = e.sent().renderFooter),
                    (null == n ? void 0 : n.copyrightImage) &&
                      (n.logo = { src: n.copyrightImage, height: 66 }),
                    r(t, n),
                    [2, new L()]
                  );
              }
        ...
        J = { insertFooter: q, renderFooter: q },
        B = function (t) {
          return (0, e.mG)(void 0, void 0, void 0, function () {
            return (0, e.Jh)(this, function (e) {
              switch (e.label) {
        ...
        F = { insertFooter: B, renderFooter: B },
        K = function (t) {
          return (0, e.mG)(void 0, void 0, void 0, function () {
            var r, o;
            return (0, e.Jh)(this, function (e) {
              switch (e.label) {
                case 0:
                  return [4, a.e(815).then(a.bind(a, 3815))];
                case 1:
                  return ((r = e.sent().renderFooter), [4, z()]);
                case 2:
                  return (
                    (o = e.sent()),
                    r(t, {
                      ...
                      siteInfos: [
                        "ICP",
                        { content: A.endfield.NCL },
                        { content: A.endfield.approval },
                        { content: A.endfield.ISBN },
                        "PSR",
                      ],
                      versionMeta: o.data,
                      ageTips: {
                        icon: n.L.endfield["age-tip"],
                        content: A.arknights.ageTips.join("；\n"),
                      },
                      externalLinks: [
                        "reportIllegalInfo",
                  ...
                  case 1:
                    return (
                      (0, e.sent().renderFooter)(t, {
                        ...
                        links: [
                          {
                            url: "https://user.hypergryph.com/protocol/plain/endfield_cloud/service",
                            name: "游戏使用许可及服务协议",
                          },
                          {
                            url: "https://user.hypergryph.com/protocol/plain/endfield_cloud/privacy",
                            name: "个人信息保护政策",
                          },
                          {
                            url: "https://user.hypergryph.com/protocol/plain/endfield_cloud/children_privacy",
                            name: "儿童个人信息保护政策",
                          },
                          "custody",
                          {
                            url: "https://customer-service.hypergryph.com/cloud_endfield",
                            name: "客服中心",
                          },
                        ],
                        siteInfos: [
                  ...
                  case 1:
                    return [
                      2,
                      {
                        result: !!(t = e.sent()),
                        data: {
                          product: "ENDFIELD_CLOUD",
                          nameEN: "ARKNIGHTS: ENDFIELD · CLOUD",
                          nameCN: (null == t ? void 0 : t.name) || "云·终末地",
                          version: (null == t ? void 0 : t.version) || "-",
                          updatedAt: (null == t ? void 0 : t.updatedAt) || "-",
                          developer: (null == t ? void 0 : t.developer) || "-",
                        },
      ...
      var Q = {
          sendEmailCode: function (t) {
            return (0, e.mG)(this, void 0, void 0, function () {
              return (0, e.Jh)(this, function (e) {
                return [2, _().HG_SERVICE.general.sendEmailCode(t)];
              });
            });
          },
        },
      ...
      var et,
        ...
        rt = a(8003),
        ot = rt.Z["__core-js_shared__"],
        it = (et = /[^.]+$/.exec((ot && ot.keys && ot.keys.IE_PROTO) || ""))
          ? "Symbol(src)_1." + et
          : "";
      var at = function (t) {
          return !!it && it in t;
      ...
      var vt = function (t) {
        return !(!(0, tt.Z)(t) || at(t)) && (nt(t) ? ft : ut).test(ct(t));
      };
      var gt = function (t, e) {
      ...
      var Ct = function (t) {
        var e = this.__data__;
        return yt ? void 0 !== e[t] : kt.call(e, t);
      };
      var Ot = function (t, e) {
        var n = this.__data__;
        return (
      ...
      ((Et.prototype.clear = bt),
        (Et.prototype.delete = wt),
        (Et.prototype.get = St),
        (Et.prototype.has = Ct),
        (Et.prototype.set = Ot));
      var It = Et;
      ...
      var Lt = function (t) {
        ...
        return (
          !(n < 0) &&
          (n == e.length - 1 ? e.pop() : Dt.call(e, n, 1), --this.size, !0)
        );
      };
      var Pt = function (t) {
        var e = this.__data__,
      ...
      var Ht = function (t, e) {
        var n = t.__data__;
        return Ut(e) ? n["string" == typeof e ? "string" : "hash"] : n.map;
      };
      var qt = function (t) {
      ...
      ((Qt.prototype.add = Qt.prototype.push = Wt), (Qt.prototype.has = Zt));
      var Vt = Qt;
      ...
      var ee = function (t, e, n) {
        return e == e ? te(t, e, n) : Yt(t, Xt, n);
      };
      var ne = function (t, e) {
        return !!(null == t ? 0 : t.length) && ee(t, e, 0) > -1;
      };
      ...
      var le = function (t) {
        ...
        de = (function (t) {
          function n(e) {
            ...
            return ((a.type = n.type), (a.status = o), (a.data = i), a);
          }
          return ((0, e.ZT)(n, t), (n.type = "bindingServerError"), n);
        })(Error);
      function pe(t) {
        var n, r;
        return (0, e.mG)(this, void 0, void 0, function () {
      ...
      function fe(t, n, r) {
        return (0, e.mG)(this, void 0, void 0, function () {
          ...
          return (0, e.Jh)(this, function (e) {
            switch (e.label) {
              case 0:
                ((o = "".concat(i.bindingServer.getHost()).concat(t)),
                  (e.label = 1));
              case 1:
                return (
                  e.trys.push([1, 3, , 4]),
              ...
              case 2:
                if ((a = e.sent()).data.status === he) return [2, a.data];
                throw new de(a);
              case 3:
                if (((s = e.sent()), (u = s).type === de.type)) throw u;
                if (u.status && u.response)
                  throw new de({ status: u.status, data: u.response.data });
                throw u;
              case 4:
                return [2];
            }
      ...
      var ve = function (t) {
          var e = t.token,
            n = t.appCode;
          return pe(function () {
            return fe("/account/reservation/v1/query", "GET", {
              token: e,
              appCode: n,
            });
          });
        ...
        ge = function (t) {
          var e = t.token,
            ...
            o = t.platform;
          return pe(function () {
            return fe("/account/reservation/v1/apply", "POST", {
              token: e,
              appCode: n,
              source: r,
              platform: o,
        ...
        ye = function () {
          return (0, e.mG)(void 0, void 0, void 0, function () {
            ...
            return (0, e.Jh)(this, function (s) {
              switch (s.label) {
                case 0:
                  return [4, (t = S()).getToken()];
                case 1:
                  return (n = s.sent()).result &&
                    (null === (i = n.data) || void 0 === i ? void 0 : i.token)
                    ? [4, t.grant(r.appCode)]
                    : [2, (0, e.pi)((0, e.pi)({}, n), { data: void 0 })];
                case 2:
                  return (o = s.sent()).result &&
                    (null === (a = o.data) || void 0 === a ? void 0 : a.token)
                    ? [2, o]
                    : [2, (0, e.pi)((0, e.pi)({}, o), { data: void 0 })];
              }
            });
          });
        },
        be = {
          doReservation: function (t, n) {
            return (0, e.mG)(void 0, void 0, void 0, function () {
              var r, o;
              return (0, e.Jh)(this, function (i) {
                switch (i.label) {
                  ...
                  case 1:
                    return (
                      (r = i.sent()),
                      (null === (o = r.data) || void 0 === o ? void 0 : o.token)
                        ? [
                            2,
                            ge({
                              token: r.data.token,
                              appCode: t,
                              platform: le(n.platform),
                              source: me[n.source],
                            }),
                          ]
                        : [2, (0, e.pi)((0, e.pi)({}, r), { data: void 0 })]
                    );
                }
              });
            });
                  ...
                  case 1:
                    return (
                      ...
                      (null === (r = n.data) || void 0 === r ? void 0 : r.token)
                        ? [2, ve({ token: n.data.token, appCode: t })]
                        : [2, (0, e.pi)((0, e.pi)({}, n), { data: void 0 })]
                    );
                }
              });
      ...
      var _e = !navigator.userAgent.match(
      ...
      var ke = (function () {
          function t(t, n) {
              ...
              (this.shareLinkInSkland = function () {
                return (0, e.mG)(r, void 0, void 0, function () {
                  ...
                  return (0, e.Jh)(this, function (e) {
                    switch (e.label) {
                      case 0:
                        return [4, a.e(561).then(a.bind(a, 7561))];
                      case 1:
                  ...
                  return (0, e.Jh)(this, function (e) {
                    switch (e.label) {
                      ...
                      case 2:
                        return (e.sent(), [2, !0]);
                      case 3:
                        return ((n = e.sent()), console.error(n), [2, !1]);
                      case 4:
                        return [2];
                    }
                  });
            ...
            var o = { share_type: "link" };
            (void 0 !== this.shareBy && (o.share_by = this.shareBy.toString()),
              (this.url = we(this.url, o)));
          }
          return (
              ...
              return (0, e.Jh)(this, function (d) {
                switch (d.label) {
                  case 0:
                    return (
                      d.trys.push([0, 3, , 4]),
                      [4, a.e(592).then(a.t.bind(a, 2592, 19))]
                    );
                  case 1:
                    return (
                      (t = d.sent()),
                      (i = { share_type: "qrcode" }),
                      void 0 !== r && (i.share_by = r.toString()),
                      (s = we(n, i)),
                      (c = {
                        width: 256,
                        margin: 1,
        ...
        Oe = (function () {
          ...
          return (
            (t.prototype.skland = function () {
              return (0, e.mG)(this, void 0, void 0, function () {
                return (0, e.Jh)(this, function (t) {
                  return [
                    2,
                    [{ key: "link-in-skland", icon: a(7317), title: "分享" }],
                  ];
                });
              });
            }),
            (t.prototype.pc = function () {
              return [
                { key: "weibo", icon: a(8185), title: "微博" },
                { key: "qq", icon: a(3491), title: "QQ" },
                { key: "qzone", icon: a(7376), title: "QQ空间" },
                { key: "copy", icon: a(6290), title: "复制链接" },
              ];
            }),
            (t.prototype.mobile = function () {
              return Se(this.params)
                ? [
                    { key: "system", icon: a(7317), title: "系统分享" },
                    { key: "copy", icon: a(6290), title: "复制链接" },
                  ]
                : [{ key: "copy", icon: a(6290), title: "复制链接" }];
            }),
        ...
        Ee = (function () {
          ...
          return (
            (t.prototype.setGlobalConfig = function (t, n) {
              ((this.params = t),
                (this.options = (0, e.pi)((0, e.pi)({}, this.options), n)));
            }),
            (t.prototype.shareSiteTo = function (t, n, r) {
              var o;
              return (0, e.mG)(this, void 0, void 0, function () {
                var i, a;
                return (0, e.Jh)(this, function (e) {
                  switch (e.label) {
                    case 0:
                      if (
                        !(i = {
                          params: n || this.params,
                          options: r || this.options,
                        }).params
                      )
                        throw new Error(
                          "share params not set, you should set global config params by setGlobalConfig or provide params to function",
                        );
                      return [4, new ke(i.params, i.options).share(t)];
                    case 1:
                      return (
                        (a = e.sent()) &&
                          N.event("social_media_share", {
            ...
            (t.prototype.getAvailableChannels = function (t) {
              return (0, e.mG)(this, void 0, void 0, function () {
                var n;
                return (0, e.Jh)(this, function (e) {
                  if (!(n = (null == t ? void 0 : t.params) || this.params))
                    throw new Error(
                      "Share parameters are required. Please use setGlobalConfig to set default params or provide params to this function",
                    );
                  return [2, new Oe(n).getChannels()];
                });
              });
            }),
            t
                  ...
                  return (
                    (0, e.sent().renderFooter)(t, {
                      ...
                      siteInfos: [
                        "ICP",
                        "NCL",
                        { content: A.popucom.approval },
                        { content: A.popucom.ISBN },
                        "PSR",
                      ],
                      externalLinks: [
                        "reportIllegalInfo",
        ...
        xe = { insertFooter: Te, renderFooter: Te },
        Ae = {
          host: "https://core-api-survey-prod.hypergryph.com",
        ...
        De = (function (t) {
          function n(e) {
            ...
            return ((s.type = n.type), (s.statusCode = o), (s.resBody = a), s);
          }
          return ((0, e.ZT)(n, t), (n.type = "webSurveyServerError"), n);
        })(Error),
        Le = function (t) {
          return (null == t ? void 0 : t.type) === De.type;
        };
      function Pe(t) {
        return (0, e.mG)(this, void 0, void 0, function () {
          var n, r, o;
                ...
                return (
                  ...
                  Le((o = r))
                    ? [
                        2,
                        (0, e.pi)(
                          (0, e.pi)({}, (null == o ? void 0 : o.resBody) || {}),
                          { statusCode: o.statusCode, result: !1 },
                        ),
                      ]
                    : (console.warn(o),
                      [
                        2,
                        {
                          result: !1,
                          msg:
                            (null == o ? void 0 : o.message) || "network error",
                        },
                      ])
                );
              case 3:
                      ...
                      (0, e.mG)(this, void 0, void 0, function () {
                        ...
                        return (0, e.Jh)(this, function (e) {
                          switch (e.label) {
                            ...
                            case 1:
                              if (0 === (o = e.sent()).data.code)
                                return [2, o.data];
                              throw new De({ resBody: o.data });
                            case 2:
                              if (((i = e.sent()), Le((a = i)))) throw a;
                              if (a.status && a.response)
                                throw new De({
                                  statusCode: a.status,
                                  resBody: a.response.data,
                                });
                              throw a;
                            case 3:
                              return [2];
              ...
              return (0, e.Jh)(this, function (i) {
                switch (i.label) {
                  case 0:
                    return [
                      4,
                      (0, e.mG)(void 0, void 0, void 0, function () {
                        var t, n;
                        return (0, e.Jh)(this, function (r) {
                          switch (r.label) {
                            case 0:
                              return [4, S().grant(Ae.appCode, 1)];
                            case 1:
                              return (t = r.sent()).result &&
                                (null === (n = t.data) || void 0 === n
                                  ? void 0
                  ...
                  case 1:
                    return (
                      (n = i.sent()),
                      (null === (o = n.data) || void 0 === o ? void 0 : o.token)
                        ? [4, Me({ token: n.data.token, surveyId: t })]
                        : [2, (0, e.pi)((0, e.pi)({}, n), { data: void 0 })]
                    );
                  case 2:
                    return (
                      ...
                      [
                        2,
                        (0, e.pi)((0, e.pi)({}, r), {
                          result: r.result || 2 === r.code,
                          data: { answered: 2 === r.code },
                        }),
                      ]
                    );
                }
          ...
          return {
            setHost: function (e) {
              return (
                t.forEach(function (t) {
                  var n;
                  return null === (n = null == t ? void 0 : t.setHost) ||
                    void 0 === n
                    ? void 0
                    : n.call(t, e);
                }),
              ...
              return (
                (null ===
                  (n =
                    null ===
                      (e = t.find(function (t) {
                        return null == t ? void 0 : t.getHost;
                      })) || void 0 === e
                      ? void 0
                      : e.getHost) || void 0 === n
                  ? void 0
      ...
      var Ue,
        ...
        Je =
          ((Ue = i),
          void 0 === (He = qe.hostConfig || qe.host) && (He = {}),
          {
            apiServer: $e(Ue.apiServer, He.apiServer),
            bindingServer: $e(Ue.bindingServer, He.bindingServer),
            accountServer: $e(He.accountServer),
            hgServer: $e(He.hgServer || He.accountServer),
            u8Server: $e(He.u8Server),
            roleServer: $e(He.roleServer),
          }),
        Be = (0, e.pi)(
          (0, e.pi)(
            {
      ...
      location &&
        ...
        i.apiServer.setHost("https://web-api.skland.com");
      var Fe = window._HG_WEB_SDK_INIT_OPTIONS;
      for (
        Fe &&
          Fe.host &&
          Fe.host.apiServer &&
          i.apiServer.setHost(Fe.host.apiServer),
          window.HG_SDK = Be;
        null === (je = window._HG_SDK_CALLBACK_QUEUE) || void 0 === je
          ? void 0
          : je.length;
      )
        null === (Ge = window._HG_SDK_CALLBACK_QUEUE.shift()) ||
          void 0 === Ge ||
          Ge();
